...
Partial Class MainForm
    ...
    Private Sub InitializeComponent()
        Dim PanelDefaultVersion As System.Windows.Forms.Panel
        Dim LabelDefaultVersion As System.Windows.Forms.Label
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(MainForm))
        Dim LabelKernel As System.Windows.Forms.Label
        Dim LabelKernelCommandLine As System.Windows.Forms.Label
        Dim LabelVmIdleTimeout As System.Windows.Forms.Label
        Dim LabelSwapFile As System.Windows.Forms.Label
        ...
        PanelDefaultVersion = New System.Windows.Forms.Panel()
        LabelDefaultVersion = New System.Windows.Forms.Label()
        LabelKernel = New System.Windows.Forms.Label()
        LabelKernelCommandLine = New System.Windows.Forms.Label()
        LabelVmIdleTimeout = New System.Windows.Forms.Label()
        LabelSwapFile = New System.Windows.Forms.Label()
        PanelDefaultVersion.SuspendLayout()
        ...
        'PanelDefaultVersion
        '
        PanelDefaultVersion.Controls.Add(LabelDefaultVersion)
        PanelDefaultVersion.Controls.Add(Me.RadioWSL1)
        PanelDefaultVersion.Controls.Add(Me.RadioWSL2)
        PanelDefaultVersion.Controls.Add(Me.LabelInboxWSLNotInstalled)
        PanelDefaultVersion.Controls.Add(Me.LabelWSLUpdateIsRecommended)
        resources.ApplyResources(PanelDefaultVersion, "PanelDefaultVersion")
        PanelDefaultVersion.Name = "PanelDefaultVersion"
        '
        'LabelDefaultVersion
        '
        resources.ApplyResources(LabelDefaultVersion, "LabelDefaultVersion")
        LabelDefaultVersion.Name = "LabelDefaultVersion"
        LabelDefaultVersion.UseCompatibleTextRendering = True
        '
        'RadioWSL1
        '
        ...
        'LabelKernel
        '
        resources.ApplyResources(LabelKernel, "LabelKernel")
        LabelKernel.Name = "LabelKernel"
        LabelKernel.UseCompatibleTextRendering = True
        '
        'LabelKernelCommandLine
        '
        resources.ApplyResources(LabelKernelCommandLine, "LabelKernelCommandLine")
        LabelKernelCommandLine.Name = "LabelKernelCommandLine"
        LabelKernelCommandLine.UseCompatibleTextRendering = True
        '
        'LabelVmIdleTimeout
        '
        resources.ApplyResources(LabelVmIdleTimeout, "LabelVmIdleTimeout")
        LabelVmIdleTimeout.Name = "LabelVmIdleTimeout"
        '
        'LabelSwapFile
        '
        resources.ApplyResources(LabelSwapFile, "LabelSwapFile")
        LabelSwapFile.Name = "LabelSwapFile"
        '
        'LabelMemory
        '
        ...
        'GroupBoxGeneral
        '
        Me.GroupBoxGeneral.Controls.Add(PanelDefaultVersion)
        ...
        '
        Me.GroupBoxConfiguration.Controls.Add(LabelKernel)
        ...
        Me.GroupBoxConfiguration.Controls.Add(LabelKernelCommandLine)
        ...
        Me.GroupBoxConfiguration.Controls.Add(LabelSwapFile)
        ...
        Me.GroupBoxConfiguration.Controls.Add(LabelVmIdleTimeout)
        ...
        'PageSettings
        '
        Me.PageSettings.Controls.Add(Me.GroupBoxConfiguration)
        Me.PageSettings.Controls.Add(Me.GroupBoxGeneral)
        ...
        Me.Name = "MainForm"
        PanelDefaultVersion.ResumeLayout(False)
        PanelDefaultVersion.PerformLayout()
    ...
    Friend WithEvents PanelDefaultVersion As Panel
